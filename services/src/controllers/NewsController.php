<?php
    ...
    class NewsController extends Controller {
        ...
        public function removeNews($request, $response, $args){
            try{
                $params = $request->getParsedBody();
               
                $id = $params['obj']['Data'];
                $result = NewsService::removeNews($id);
         ...
         public function delNews($request, $response, $args){
            try{
                $params = $request->getParsedBody();
               
                $id = $params['obj']['Data'];
                $result = NewsService::delNews($id);
                $this->data_result['DATA']['result'] = $result;
                return $this->returnResponse(200, $this->data_result, $response, false);
