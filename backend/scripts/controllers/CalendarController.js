angular.module('e-homework').controller('CalendarController', function ($scope, $uibModal, $compile, $cookies, $filter, $state, $routeParams, HTTPService, IndexOverlayFactory) {
    ...
    $scope.removeData = function (id) {
        ...
        modalInstance.result.then(function (valResult) {
            IndexOverlayFactory.overlayShow();
            var params = {'id': id};
            HTTPService.clientRequest('calendar/delete', params).then(function (result) {
                // $scope.load('Datas');
                $scope.loadList('calendar/list');
                IndexOverlayFactory.overlayHide();
            });
        });
    ...
    $scope.edit = function (id) {
        ...
        window.location.href = '#/calendar/add/' + id;
    }
