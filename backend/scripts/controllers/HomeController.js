angular.module('e-homework').controller('HomeController', function ($scope, $cookies, $filter, $state, $uibModal, $routeParams, HTTPService, IndexOverlayFactory) {
    ...
    $scope.edit = function (data) {
        ...
        if ($scope.SlideShow.start_date != null && $scope.SlideShow.start_date != undefined && $scope.SlideShow.start_date != '') {
            $scope.SlideShow.start_date = makeDate($scope.SlideShow.start_date);
        }

        if ($scope.SlideShow.end_date != null && $scope.SlideShow.end_date != undefined && $scope.SlideShow.end_date != '') {
            $scope.SlideShow.end_date = makeDate($scope.SlideShow.end_date);
        }
    ...
    $scope.save = function (action, SlideShow, AttachFile) {
        ...
        if ($scope.SlideShow.start_date != null && $scope.SlideShow.start_date != undefined && $scope.SlideShow.start_date != '') {
            $scope.SlideShow.start_date = makeSQLDate($scope.SlideShow.start_date);
        }

        if ($scope.SlideShow.end_date != null && $scope.SlideShow.end_date != undefined && $scope.SlideShow.end_date != '') {
            $scope.SlideShow.end_date = makeSQLDate($scope.SlideShow.end_date);
        }
