angular.module('e-homework').controller('GalleryController', function($scope, $compile, $cookies, $filter, $state, $routeParams, $uibModal, HTTPService, IndexOverlayFactory) {
    IndexOverlayFactory.overlayShow();

    $scope.page_type = 'gallery';
    ...
    $scope.suggestImage = function(data){
        var modalInstance = $uibModal.open({
            animation: false,
